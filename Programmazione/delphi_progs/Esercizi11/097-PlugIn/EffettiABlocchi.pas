...
begin
  with MotoreSlideShow do begin
    RegistraEffetto('blocchi_oriz', TEffettoABlocchiOriz);
    RegistraEffetto('blocchi_vert', TEffettoABlocchiVert);
    RegistraEffetto('scacchi', TEffettoAScacchi);
    RegistraEffetto('random', TEffettoRandom);
  end;
end;
