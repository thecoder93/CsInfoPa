...
uses
  Windows, SlideShow, Graphics, ExtCtrls;
...
function TEffettoScorrimento.GetRitardo: Integer;
begin
  Result := StrToIntDef(Parametri.Values['Ritardo'], 0);
end;
...
initialization
  TMotoreSlideShow.RegistraEffetto('taglio_netto', TEffettoTaglioNetto);
  TMotoreSlideShow.RegistraEffetto('scorrimento_sx', TEffettoScorrimentoSx);
  TMotoreSlideShow.RegistraEffetto('scorrimento_dx', TEffettoScorrimentoDx);
