...
procedure TFmRubricaCDS.FormCreate(Sender: TObject);
begin
...
procedure TFmRubricaCDS.FormDestroy(Sender: TObject);
begin
...
procedure TFmRubricaCDS.SalvaRubrica;
begin
...
procedure TFmRubricaCDS.Esci1Click(Sender: TObject);
begin
  Close;
end;

procedure TFmRubricaCDS.Aggiungi1Click(Sender: TObject);
begin
...
procedure TFmRubricaCDS.Elimina1Click(Sender: TObject);
begin
...
procedure TFmRubricaCDS.EliminaTutti1Click(Sender: TObject);
begin
  // Elimino solo se il dataset non è vuoto nè in modifica.
  if not CdsRubrica.IsEmpty and not (CdsRubrica.State in dsEditModes) then
