...
uses
  ...
  ComCtrls, ScoreBoard, frmScoreBoard, XPMan, frmLevelsEditor, frmGameBoardEditor;

const XMLFileName_ScoreBoard = 'SCORES.XML';
...
begin
	...
	Deserialize(self.GameGrid.GameBoard, GameLevels[CurrentLevelIndex].FileName);
...
begin
	...
	if (self.GameState <> gsWaitToStart) then
	begin
...
begin
	...
	try
		...
		try
			...
			ScoreBoardForm.FillListView(scoreboard);
